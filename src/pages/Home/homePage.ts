    ...
    render: async () => {
      ...
      const data: Product[] = res.data
        ...
        <div class="container mx-auto grid grid-cols-4 my-3">
          <div class="">
            <a class="mt-2" href="#">
              <div class="flex w-[300px] rounded-md hover:bg-gray-300 mt-2 font-semibold">
          ...
          <div class="col-span-3">
            <img class=" w-[1000px] h-[330px]" src="https://cdn2.cellphones.com.vn/690x300/https://dashboard.cellphones.com.vn/storage/khai-truong-mien-nam.png" alt="">
          </div>
        </div>
        <!-- Navbar -->
        <!-- Body -->
        <div class="container mx-auto text-center text-2xl mt-8">
          SẢN PHẨM MỚI NHẤT
        </div>
