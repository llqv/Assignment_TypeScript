    ...
    render: async () => {
      ...
      <div class="w-full">
        ...
        <div class="w-1/2 font-semibold mt-4">
          ...
          <input class="border border-inherit rounded-md h-12 mx-4 text-xl font-semibold " type="number" id="originalPrice">
        </div>
        <div class="w-1/2 font-semibold mt-4">
        <h3 class="mx-4">Giá khuyến mại</h3>
          <input class="border border-inherit rounded-md h-12 mx-4 text-xl font-semibold" type="number" id="saleOffPrice">
        </div>
        </div>
